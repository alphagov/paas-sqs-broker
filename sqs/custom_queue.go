...
// Custom Queue AWS CloudFormation Resource (AWS::SQS::Queue)
// copied from upstream, but with `string` params where we need to pass in a ref
// because of https://github.com/awslabs/goformation/issues/252
